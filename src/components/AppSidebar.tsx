      ...
      <SidebarContent className="pt-0">
        ...
        {roleLoading ? (
          ...
          <>
            ...
            {/* Carteira CAC */}
            <SidebarGroup>
              <SidebarGroupLabel className="text-[11px] font-semibold uppercase tracking-[0.15em] text-primary/80">Carteira CAC</SidebarGroupLabel>
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
